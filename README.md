# Payment Gateway API Using Java,Spring Boot & Spring Security

The API provides a set of endpoints for managing user accounts, fund transfers, and transactions. This project aims to facilitate secure and efficient banking operations for users.
...
1. Clone the repository: `git clone https://github.com/Adinarayana11/PayGuard.git`
2. Navigate to the project folder: `cd PayGuard`
